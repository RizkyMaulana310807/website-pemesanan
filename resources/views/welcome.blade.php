...
<body class="bg-[#fff9f2] font-sans">
    ...
    <div class="text-center px-4 py-6">
        ...
        <div class="flex justify-center gap-4 mt-6">
            <button class="bg-[#972219] text-white px-5 py-2 rounded-full">Liat Menu</button>
            <button class="bg-[#09417e] text-white px-5 py-2 rounded-full">Pre Order</button>
        </div>
    </div>
    ...
    <div class="flex flex-row">
        ...
        <div>
            <h1 class="text-[#09417e] font-bold text-2xl">Apple<br>Fritters</h1>
    ...
    <div class="flex flex-row justify-around">
        <div class="">
            <h1 class="text-right text-[#justify-end] font-bold text-2xl">Japanesse<br>Coffee Jelly</h1>
